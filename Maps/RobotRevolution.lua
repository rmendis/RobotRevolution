-- RobotRevolution
-- Author: blkbutterfly
-- Copy of Tilted_Axis.lua (Fixed) map/mod
-- DateCreated: 1/14/2024 5:44:52 PM
--------------------------------------------------------------
...
local g_iE = nil			-- distance to equator from north pole
...
function GenerateMap()
	...
	if (rainfall == nil or rainfall == 4) then
	...
	while done == false do
		...
		for x = 0, g_iW - 1 do
			for y = 0, g_iH - 1 do
				...
				local iDistance = __GetPlotDistance(x, y, g_xCenter, g_yCenter);
